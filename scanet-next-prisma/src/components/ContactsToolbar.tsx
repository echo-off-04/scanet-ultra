                ...
                <div className="flex flex-wrap gap-2 items-center">
                    ...
                    >
                        ...
                        {activeFiltersCount > 0 && (
                            <span className="flex h-5 min-w-[20px] items-center justify-center rounded-full bg-white px-1.5 text-xs font-semibold text-slate-700">{activeFiltersCount}</span>
                        )}
                    </button>
