            ...
            <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:p-6">
                ...
                <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-5">
                    ...
                    <div className="flex items-center gap-2">
                        <button onClick={handleRefresh} disabled={refreshing} className="rounded-xl p-2 transition-colors hover:bg-slate-100" title="Actualiser les valeurs">
                        ...
                        <button onClick={() => { setEditObjective(null); setShowAddModal(true); }} className="btn-primary px-3 py-1.5 text-xs">
                ...
                {filteredObjectives.length === 0 ? (
                    <div className="text-center py-10">
                        ...
                        {filterStatus === 'all' && (
                            <button onClick={() => { setEditObjective(null); setShowAddModal(true); }} className="btn-primary inline-flex px-4 py-2 text-sm">
                                <Plus className="h-4 w-4" />Créer mon premier objectif
                            </button>
                        )}
                    </div>
                ) : (
