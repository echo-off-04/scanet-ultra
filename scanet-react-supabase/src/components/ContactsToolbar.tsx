      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          <div className="flex gap-2 bg-white/40 backdrop-blur-sm rounded-2xl p-1.5 border border-white/60">
            <button
              ...
              className={`p-2 rounded-xl transition-all ${
                viewMode === 'grid'
                  ? 'bg-gradient-to-br from-white to-blue-50 shadow-md text-blue-600'
            ...
            <button
              ...
              title="Vue en photos"
            >
              <Images className="w-4 h-4 lg:w-5 lg:h-5" />
            </button>
          </div>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 text-sm lg:text-base rounded-2xl transition-all whitespace-nowrap font-semibold shadow-sm hover:shadow-md ${
          ...
          >
            ...
            {activeFiltersCount > 0 && (
              <span className="bg-white/25 rounded-full min-w-[20px] h-5 px-1.5 flex items-center justify-center text-xs font-bold">
                {activeFiltersCount}
              </span>
            )}
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white/50 backdrop-blur-sm border border-white/60 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-sm transition-all"
              />
            </div>
