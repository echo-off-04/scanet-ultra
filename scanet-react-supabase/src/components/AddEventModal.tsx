  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (newEvent && newEvent.start_date) {
        await notifyEventCreated(user.id, newEvent.name, newEvent.start_date, newEvent.id);
      }
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all"
                    placeholder="Salon Tech 2024"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all resize-none"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all"
                    placeholder="Paris, France ou https://zoom.us/..."
                  />
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, target_participants: e.target.value === '' ? '' : parseInt(e.target.value) })}
                    className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all"
                    placeholder="Ex: 50"
                  />
                </div>
                    ...
                    {OBJECTIVES.map((obj) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all ${
                          formData.secondary_objectives.includes(obj.value)
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-end p-4 sm:p-6 border-t border-gray-200 bg-gray-50">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="px-6 py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 transition-all font-semibold disabled:opacity-50 order-2 sm:order-1"
            >
              Annuler
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all font-semibold shadow-md disabled:opacity-50 flex items-center justify-center gap-2 order-1 sm:order-2"
            >
              {loading ? (
                <>
