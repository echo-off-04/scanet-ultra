...
import { Users, Mail, Lock, User, Eye, EyeOff, TrendingUp, CheckCircle } from 'lucide-react';
...
export function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-accent-blue relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0E3A5D 0%, #1e5a8e 100%)' }}>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="mt-12 bg-white/10 backdrop-blur rounded-2xl p-6">
            <p className="text-blue-50 italic mb-4">
              "Scanetwork a révolutionné ma façon de gérer mes contacts. Je n'oublie plus jamais de relancer un prospect !"
            </p>
        ...
        <div className="w-full max-w-md">
          <div className={`bg-white rounded-3xl shadow-xl p-8 transition-all ${formShake ? 'animate-shake' : ''}`}>
            ...
            <p className="text-center text-gray-500 mb-8">
              {isSignUp
                ? 'Commencez à gérer votre réseau professionnel'
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isSignUp && (
                <div className="text-right">
                  <Link
                    to="/forgot-password"
                    className="text-sm text-[#0E3A5D] hover:text-[#1e5a8e] font-medium transition-colors"
                  >
                    Mot de passe oublié ?
                  </Link>
                </div>
            ...
            <p className="mt-8 text-center text-xs text-gray-400">
              ...
              <a href="#" className="text-[#0E3A5D] hover:underline">
