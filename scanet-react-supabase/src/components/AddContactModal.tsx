...
export function AddContactModal({ onClose, onContactAdded, defaultIsMember = false, onNavigateToEnterprise }: AddContactModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.company.trim()) {
      validationErrors.company = 'L\'entreprise est obligatoire';
    }

    if (!formData.job_title.trim()) {
      validationErrors.job_title = 'La profession est obligatoire';
    }
    ...
    try {
      ...
      if (contactError) {
        ...
        const errorMessage = contactError.message || 'Erreur inconnue';
        showToast('Erreur', `Erreur lors de l'ajout du contact: ${errorMessage}`, 'error');
        throw contactError;
      }
      ...
      if (contactData) {
        ...
        if (selectedRelations.length > 0) {
          const relationshipsToInsert = selectedRelations.map(relatedContactId => ({
            contact_id: contactData.id,
  ...
  return (
    <>
            ...
            <form onSubmit={handleSubmit} className="relative p-4 sm:p-8 lg:p-12 space-y-6 sm:space-y-8">
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="text-sm sm:text-base text-gray-500 max-w-2xl mx-auto px-2">
                  Remplissez les informations ci-dessous pour ajouter un nouveau contact à votre réseau professionnel
                </p>
              </div>
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 ${
                        errors.first_name ? 'ring-2 ring-red-500' : 'focus:ring-blue-400'
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 ${
                        errors.last_name ? 'ring-2 ring-red-500' : 'focus:ring-blue-400'
                      } placeholder-gray-500 text-gray-900 transition-all`}
                      placeholder="Dupont"
                    />
                    {errors.last_name && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 ${
                        errors.email ? 'ring-2 ring-red-500' : 'focus:ring-blue-400'
                      } placeholder-gray-500 text-gray-900 transition-all`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder-gray-500 text-gray-900 transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className="w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder-gray-500 text-gray-900 resize-none transition-all"
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <select
                          ...
                          className="w-full px-5 py-3 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-900 transition-all cursor-pointer text-sm"
                        >
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-5 py-3 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder-gray-500 text-gray-900 transition-all text-sm"
                          />
                          {contactSearchQuery && (
                            <button
                              type="button"
                        ...
                        <div className="max-h-48 overflow-y-auto bg-gray-50 rounded-2xl p-3 space-y-2">
                          {existingContacts
                            ...
                            .map((contact) => (
                              <label
                                key={contact.id}
                                className="flex items-start gap-3 p-3 hover:bg-white rounded-xl cursor-pointer transition-colors"
                              >
                                <input
                                  type="checkbox"
                                  checked={selectedRelations.includes(contact.id)}
                                  onChange={(e) => {
                                    if (e.target.checked) {
                                      setSelectedRelations([...selectedRelations, contact.id]);
                                    } else {
                                      setSelectedRelations(selectedRelations.filter(id => id !== contact.id));
                                    }
                                  }}
                                  className="mt-0.5 w-5 h-5 text-blue-600 rounded focus:ring-2 focus:ring-blue-400"
                                />
                        ...
                        {selectedRelations.length > 0 && (
                          <p className="text-xs text-gray-600 px-2">
                            {selectedRelations.length} contact{selectedRelations.length > 1 ? 's' : ''} sélectionné{selectedRelations.length > 1 ? 's' : ''}
                          </p>
                        )}
                      </div>
                    </div>
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 ${
                        errors.company ? 'ring-2 ring-red-500' : 'focus:ring-blue-400'
                      } placeholder-gray-500 text-gray-900 transition-all`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 ${
                        errors.job_title ? 'ring-2 ring-red-500' : 'focus:ring-blue-400'
                      } placeholder-gray-500 text-gray-900 transition-all`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-5 py-4 bg-gray-200 border-0 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-900 transition-all cursor-pointer"
                    >
                    ...
                    <label className="flex items-center gap-3 cursor-pointer group">
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked && !enterpriseExists) {
                              setShowEnterpriseWarning(true);
                            } else {
                              setFormData((prev) => ({ ...prev, is_member: e.target.checked }));
                            }
                          }}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors">
                          Définir comme membre de mon entreprise
                        </span>
                      </div>
                    </label>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 pt-4 sm:pt-6 pb-4">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-6 sm:px-8 py-3 sm:py-4 text-gray-700 font-semibold rounded-2xl hover:bg-gray-100 transition-all"
                >
                  Annuler
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg shadow-blue-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      {/* Modal d'avertissement pour l'entreprise */}
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex gap-3 w-full">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg shadow-blue-500/30"
                >
