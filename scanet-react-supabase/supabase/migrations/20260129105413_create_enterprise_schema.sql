/*
  ...
  1. Tables créées
    - `enterprises` - Informations sur les entreprises
    - `teams` - Équipes avec support hiérarchique (n-1, n-2, etc.)
    - `team_members` - Membres des équipes
    - `custom_groups` - Groupes personnalisés
    - `custom_group_members` - Membres des groupes personnalisés
    - `enterprise_objectives` - Objectifs d'entreprise
    - `team_objectives` - Objectifs d'équipe
    - `team_events` - Association équipes-événements

  2. Sécurité
    - RLS désactivé pour le développement (à activer en production)
    - Indexes pour optimiser les performances
    - Triggers pour maintenir updated_at
    - Fonction pour calculer le niveau hiérarchique des équipes
*/
